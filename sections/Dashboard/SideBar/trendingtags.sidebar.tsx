          ...
          >
            <div className="flex justify-between">
              <div>
                ...
                <div className="font-medium text-xs text-accent mb-8">
                  This Week
                </div>
              </div>
              <div>
            ...
            <div className="flex flex-col space-y-6 p-3">
                {tags.map((data,key)=>(
                    ...
                    <div className="text-black-400 font-semibold text-sm">#{data.name}</div>
                    <div className="text-black-200 font-medium text-xs">{data.posts} Posts</div>
                    <div className="pt-2">{key !== tags?.length - 1 ? <hr /> : <></>}</div>
                    </div>
                ))}
            </div>
            <CustomButton
